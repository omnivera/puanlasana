...
<video id="myVideo"  loop="true" autoplay="autoplay" controls muted>
   <source :src="itemvideogoster" type="video/mp4" />
  Your browser does not support the video tag.
</video>
<!-- <iframe id="myVideo" :src="itemvideogoster" title="YouTube video player" frameborder="0"  allow="accelerometer; autoplay; loop; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> -->
...
<div class="row">
    <div class="col-md-6">
 <div class="form-floating mb-3">
  <input type="data" autocomplete="off" required class="form-control" v-model="itemvideo" id="floatingInput" placeholder="name@example.com">
